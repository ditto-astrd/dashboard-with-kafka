package keku.board.comment.api;
...
//    commentId=175503459704057856
//      commentId=175503460727468032
//      commentId=175503460790382592
  }
  ...
  void read() {
    CommentResponse response = restClient.get()
        .uri("/v1/comments/{commentId}", 175503459704057856L)
        .retrieve()
        .body(CommentResponse.class);
