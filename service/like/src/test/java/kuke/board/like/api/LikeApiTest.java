...
class LikeApiTest {
  ...
  void likePerformanceTest() throws InterruptedException {
    ...
    likePerformanceTest(executorService, 5555L, "pessimistic-lock-1");
    likePerformanceTest(executorService, 6666L, "pessimistic-lock-2");
  ...
  void likePerformanceTest(ExecutorService executorService, Long articleId, String lockType)
    ...
    // 최초 요청시 레코드가 초기화되지 않은 경우가 있을 수 있어서 먼저 호출
